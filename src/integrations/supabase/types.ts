...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      availability_exceptions: {
        Row: {
          ...
          typ: Database["public"]["Enums"]["exception_type"];
          von: string;
        };
        Insert: {
          bis: string;
      ...
      profiles: {
        Row: { created_at: string; id: string; name: string | null; updated_at: string };
        Insert: { created_at?: string; id: string; name?: string | null; updated_at?: string };
        Update: { created_at?: string; id?: string; name?: string | null; updated_at?: string };
        Relationships: [];
      };
      user_roles: {
        Row: {
    ...
    Functions: {
      freie_zeiten: {
        Args: { _behandlungsart: string; _bis: string; _von: string };
        Returns: { start_zeit: string; end_zeit: string }[];
      };
      termin_buchen: {
        Args: {
          _anliegen: string | null;
          _behandlungsart: string;
          _email: string;
          _name: string;
          _start: string;
          _telefon: string | null;
        };
        Returns: string;
      };
      has_role: {
